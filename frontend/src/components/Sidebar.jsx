    ...
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      <div className="border-b border-base-300 w-full p-5">
        ...
        {/* TODO: Online filter toggle */}
                <div className="mt-3 flex items-center gap-1 w-full justify-start -ml-2">
          <label className="cursor-pointer flex items-center gap-1 ml-0">
            <input
              type="checkbox"
            ...
            <span className="text-xs lg:hidden">
              Show Online Users ({Math.max(onlineUsers.length - 1, 0)})
            </span>
